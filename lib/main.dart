    ...
    return Scaffold(
      ...
      body: ListView(
          ...
          padding: const EdgeInsets.only(
              ...
              top: 70.0,
              bottom: 20.0),
          children: <Widget>[_user(), _cardLine()]),
    );
  }
}
...
//     children: <Widget>[
//       Container(
//           padding: const EdgeInsets.only(left: 22.0, right: 26.0, top: 3.0),
//           width: 330,
//           height: 80,
//           decoration: BoxDecoration(
...
//         children: [
//           Container(
//               margin: const EdgeInsets.only(right: 15.0), child: _money1()),
//         ],
//       ),
//     ],
//   );
